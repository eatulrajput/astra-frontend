    ...
    <div>
      ...
      <div className="min-h-screen">
        ...
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-4 lg:grid-cols-3">
          <WobbleCard
            containerClassName="col-span-1 lg:col-span-2 h-full bg-emerald-700 min-h-[500px] lg:min-h-[300px]"
            className=""
          >
          ...
          <WobbleCard containerClassName="col-span-1 lg:col-span-3 bg-cyan-600 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
