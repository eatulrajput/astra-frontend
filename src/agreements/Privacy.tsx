export const Privacy = () => {
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 dark:text-gray-300">
      <h1 className="text-4xl font-medium text-center mb-10">Privacy Policy</h1>

      <p className="text-lg mb-8 leading-8">
        This Privacy Policy explains how this educational RAG chatbot
        application collects, uses, and handles user data.
      </p>
      ...
      <ol className="list-decimal pl-6 space-y-8 text-lg leading-8">
        <li>
          ...
          <p className="mt-2">
            This application is developed for educational purposes only and is
        ...
        <li>
          ...
          <p className="mt-2">We may collect the following types of data:</p>
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>
              Files uploaded by users (e.g., PYQs, notes, study materials)
            </li>
        ...
        <li>
          ...
          <p className="mt-2">The collected data is used to:</p>
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>
              Process and retrieve relevant information for chatbot responses
            </li>
        ...
        <li>
          ...
          <p className="mt-2">
            Uploaded files and user inputs may be temporarily stored for
            processing. While reasonable efforts are made to protect data, we do
        ...
        <li>
          ...
          <p className="mt-2">
            We do not sell, trade, or share user data with third parties. Data
            is used only within the scope of this project.
          </p>
        </li>

        <li>
          <span className="font-semibold text-xl">User Responsibility</span>
          <p className="mt-2">Users should avoid uploading:</p>
          <ul className="list-disc pl-6 mt-2 space-y-1">
        ...
        <li>
          ...
          <p className="mt-2">
            Data may be deleted periodically and is not guaranteed to be stored
            permanently.
          </p>
        </li>
