      ...
      {items.map((item, _idx) => (
        ...
        >
          ...
          <img
            ...
            src={item.image}
            alt={item.name}
            className="relative m-0! h-40 w-40 rounded-full border-2 border-emerald-200 object-cover object-top p-0! transition duration-500 group-hover:z-30 group-hover:scale-105  grayscale-100 hover:grayscale-0"
          />
        </div>
      ))}
    </>
